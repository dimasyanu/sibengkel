    ...
    <div id="sib-modal-body" class="modal-body">
        <form id="modalForm" class="form-horizontal" name="modalForm">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" name="name" id="create-service-name" placeholder="Name" value="{{ $item[0]['original']['name'] }}" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">Description</label>
                <div class="col-sm-10">
                    <textarea class="form-control" name="description" id="create-service-description" placeholder="Some description...">{{ $item[0]['original']['description'] }}</textarea>
                </div>
            </div>
            <div class="form-group">
            	...
            	<div class="col-sm-10">
                    ...
                    ?>
                        <div class="col-sm-4 text-center pick-icon<?php if($icon == $item[0]['original']['icon']) echo ' selected'; ?>">
...
<script>
    $(document).ready(function() {
        ...
        $("#btn-create-save").click(function (e) {
            ...
            formData['description'] = $('#create-service-description').html();
