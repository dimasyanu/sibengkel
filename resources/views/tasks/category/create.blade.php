<div class="modal-content">
    <div class="modal-header text-center">
        ...
        <h4 id="sib-modal-title" class="modal-title" id="sib-modal-label">Create new category</h4>
    </div>
    ...
    <div id="sib-modal-body" class="modal-body">
        <form id="modalForm" class="form-horizontal" name="modalForm">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" name="alias" id="create-service-alias" placeholder="Alias" />
                </div>
            </div>
            <div class="form-group">
