    ...
    <div id="sib-modal-body" class="modal-body">
        <form id="modalForm" class="form-horizontal" name="modalForm">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" name="alias" id="create-service-alias" placeholder="Alias" value="{{ $item[0]['original']['alias'] }}"/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    ?>
                        <div class="col-sm-1 text-center pick-icon<?php if($icon == $item[0]['original']['icon']) echo ' selected'; ?>">
...
<script>
    $(document).ready(function() {
        ...
        $("#btn-create-save").click(function (e) {
            ...
            formData['alias'] = $('#create-service-alias').val();
            formData['icon'] = $('.pick-icon.selected img').data('icon');

            var url = "/sibengkel/public/admin/category";
